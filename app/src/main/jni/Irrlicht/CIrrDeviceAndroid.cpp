...
void CIrrDeviceAndroid::createDriver()
{
	...
	ALOGV("CreationParams.DriverType   %d" , CreationParams.DriverType );
	ALOGV("CreationParams.DeviceType   %d" , CreationParams.DeviceType );
	...
	case video::EDT_OGLES1:
		#ifdef _IRR_COMPILE_WITH_OGLES1_
			{
				...
				DBG_LINE;
				ALOGV("createOGLES1Driver VideoDriver %d" , VideoDriver);
